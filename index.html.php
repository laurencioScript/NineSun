	...
	<div class="container-fluid">
		...
		<div class="row" style="margin-top: 500px;" >
			<div class="col-md-4 col-xs-4 col-sm-4">
				<button type="button" id="btn_fale_conosco" class="btn btn-link colo_btn">Fale Conosco</button>
				<button type="button" id="btn_duvidas" class="btn btn-link">Duvidas</button>	
			</div>	

			<div class="col-md-offset-5 col-md-3 col-xs-offset-3 col-xs-3 col-sm-4">
				<button type="button" id="btn_contato" class="btn btn-link">Contato</button>
				<button type="button" id="btn_sobre" class="btn btn-link">Sobre</button>	
			</div>		
		</div><!-- Row Rodape -->
