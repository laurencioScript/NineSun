<?php 
	...
	$hotel = new Hotel("",$_POST['nome'],$_POST['endereco'],$_POST['telefone'],$_POST['site'],$_POST['email'],$_POST['class'],$_POST['cidade'],$_POST['img_A'],$_POST['img_B'],$_POST['img_C'],$_POST['img_D'],$_POST['img_E']);


	$hotel->inserir();
	write_msg('Hotel cadastrado com sucesso','success');
