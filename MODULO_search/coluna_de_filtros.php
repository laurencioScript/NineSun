<div class="btn-group" >	
  	<button type="button" class="btn btn-warning dropdown-toggle" id="btn_city" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Cidades 
...
<div class="btn-group" >
  	<button type="button" class="btn btn-warning dropdown-toggle" id="btn_classificacao"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Classificação 
  		<span class="caret"></span>
  	</button>
	<ul class="dropdown-menu">
	   	<li>
...
<div class="btn-group">
  	<button type="button" class="btn btn-warning dropdown-toggle" id="btn_acomodidades" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Acomodidades 
  		<span class="caret"></span>
  	</button>
	<ul class="dropdown-menu">
	    <li><div class="col-md-offset-1">
